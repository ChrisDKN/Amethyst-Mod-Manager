...
class WabbajackView(QWidget):
    ...
    def _build(self):
        ...
        self._detail_columns.addWidget(setup, 1)
        form = QFormLayout()
        ...
        verdict_layout.addWidget(acquisition)
